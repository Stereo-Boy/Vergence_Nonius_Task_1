...
%======================================================================
    ...
    %--------------------------------------------------------------------------
        ...
        expe.instructionsVergence.fr=strcat('TEST V: des lignes vont vous etre presentées. Chaque essai commence avec la presentation',...
            ' de petits carrés. Au centre se trouve une croix de fixation. ',...
            ' Regardez-la puis appuyez sur une touche pour lancer l''essai.',...
            ' La croix est remplacée par un masque bref, suivi de deux lignes, l''une au-dessus de l''autre.',...
            ' Un point de fixation peut etre présent ou non. Votre tache est de juger si le decallage de la ligne du haut est plutot sur la',...
